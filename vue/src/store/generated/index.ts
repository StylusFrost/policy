...
import StylusFrostPolicyStylusFrostPolicyPolicy from './StylusFrost/policy/StylusFrost.policy.policy'
...
import StylusFrostPolicyPolicyPolicyV1Beta1 from './StylusFrost/policy/policy.policy.v1beta1'
...
export default { 
  ...
  StylusFrostPolicyStylusFrostPolicyPolicy: load(StylusFrostPolicyStylusFrostPolicyPolicy, 'StylusFrost.policy.policy'),
  ...
  StylusFrostPolicyPolicyPolicyV1Beta1: load(StylusFrostPolicyPolicyPolicyV1Beta1, 'policy.policy.v1beta1'),
